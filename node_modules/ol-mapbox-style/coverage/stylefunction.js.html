    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>248/395</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>159/273</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>244/388</span>
            </div>
...
<a name='L1050'></a><a href='#L1050'>1050</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">36x</span>
<span class="cline-any cline-yes">1738x</span>
<span class="cline-any cline-yes">1738x</span>
<span class="cline-any cline-yes">1738x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (color &amp;&amp; width &gt; 0) {
            ...
            stroke.setLineDash(
              paint['line-dasharray']
                ? <span class="branch-0 cbranch-no" title="branch not covered" >getValue(layer, 'paint', 'line-dasharray', zoom, f).map(</span>
<span class="fstat-no" title="function not covered" >                    fu</span>nction (x) {
...
<span class="cstat-no" title="statement not covered" >                      ctx.drawImage(</span>
                      ...
                      const data = <span class="cstat-no" title="statement not covered" >ctx.getImageData(</span>
                        0,
                        0,
                        canvas.width,
                        canvas.height
                      );
<span class="cstat-no" title="statement not covered" >                      for (let c = <span class="cstat-no" title="statement not covered" >0,</span> cc = <span class="cstat-no" title="statement not covered" >data.data.length;</span> c &lt; cc; c += 4) {</span>
                        const a = <span class="cstat-no" title="statement not covered" >iconColor.a;</span>
<span class="cstat-no" title="statement not covered" >                        if (a !== 0) {</span>
<span class="cstat-no" title="statement not covered" >                          data.data[c] = (iconColor.r * 255) / a;</span>
<span class="cstat-no" title="statement not covered" >                          data.data[c + 1] = (iconColor.g * 255) / a;</span>
<span class="cstat-no" title="statement not covered" >                          data.data[c + 2] = (iconColor.b * 255) / a;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        data.data[c + 3] = a;</span>
                      }
<span class="cstat-no" title="statement not covered" >                      ctx.putImageData(data, 0, 0);</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Nov 15 2021 12:57:56 GMT+0100 (Central European Standard Time)
            </div>
        </div>
