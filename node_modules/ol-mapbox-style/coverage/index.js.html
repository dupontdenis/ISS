    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>311/341</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">85.34% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>198/232</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>294/322</span>
            </div>
...
<span class="cstat-no" title="statement not covered" >      element.style.opacity = '';</span>
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (map.getTargetElement()) {
    updateStyle();
  }
      ...
      if (state === 'ready') {
        ...
        if (url) {
          for (let i = 0, ii = tiles.length; i &lt; ii; ++i) {
            const tile = tiles[i];
            <span class="missing-if-branch" title="if path not taken" >I</span>if (tile.indexOf('http') != 0) {
<span class="cstat-no" title="statement not covered" >              tiles[i] = url.replace(/\/?$/, '/') + tile.replace(/^\//, '');</span>
            }
          }
        }
